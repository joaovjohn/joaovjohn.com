...
export function ButtonMenu({ label = "MENU", isActive = true, className, ...props }: ButtonMenuProps) {
  const height = 94
  ...
  const rightShapeExtra = 45 // Extra space for the right triangle to be fully visible
